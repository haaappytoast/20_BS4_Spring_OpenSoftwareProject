# name of Project
- filtering the BGR image with Laplacian of Gaussian Filter

# Purpose of this code
- when image is given in BGR as "input",  filter the input with Gaussian Filter. and then filter the input with the Laplacian Filter. Then, you can get the edge of the image.

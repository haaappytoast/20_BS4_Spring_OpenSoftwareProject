...
template <typename T>
Mat cal_affine(vector<double>& ptl_x, vector<double>& ptl_y, vector<double>& ptr_x, vector<double>& ptr_y, int number_of_points);
void implement_stitching(Mat& input1, Mat& input2, vector<double>& ptl_x, vector<double>& ptl_y, vector<double>& ptr_x, vector<double>& ptr_y);

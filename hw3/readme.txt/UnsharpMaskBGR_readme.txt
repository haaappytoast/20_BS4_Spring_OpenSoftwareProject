# name of Project
- UnsharpMasking Filter on BGR image

# Purpose of this code
- when image is given in BGR as "input", filter it with the 'UnsharpMasking Filter'.
...
# How to define default parameters
	line 43: 	output = gaussianfilter(input, 1,1,1, "zero-paddle", 0.5);

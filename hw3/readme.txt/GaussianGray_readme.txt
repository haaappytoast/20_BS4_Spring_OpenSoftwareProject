# name of Project
- Gaussian Filter on grayscale image

# Purpose of this code
- when image is given in BGR as "input", convert it to grayscale first, and filter it with the 2D 'Gaussian Filter'. 
...
# How to define default parameters
	line 48: output = gaussianfilter(input_gray, 1,1,1, "adjustkernel");
	    ...
	    - in 4rd parameter, I chose the 'adjustkernel' option. you can choose other options if you want.
